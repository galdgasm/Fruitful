...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb" style="margin-left: 100px; margin-top: 1px"><a href="add_new_user.php" title="Go to Users" class="tip-bottom"><i class="icon icon-user"></i>
            Users</a></div>
    </div>

    <div id="content-header">
        <div id="breadcrumb" style="margin-left: 180px; margin-top: 1px"><a title="Go to Users" class="tip-bottom">
            Edit Users</a></div>
    </div>
    <!--End-breadcrumbs-->
        ...
        <div class="widget-content nopadding">
          <form name="form1" action="" method="post" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" placeholder="Role" name="role" readonly value="<?php echo $role; ?>"/>
               </select>
              </div>
            </div>
