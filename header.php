...
<div id="header">
    ...
    <h2 style="color: white;position: absolute">
        <a href="dashboard.html" style="color:white; margin-left: 30px; margin-top: 40px">Fruitful</a>
    </h2>
</div>
...
<div id="sidebar">
 ...
 <li class="submenu"><a href="#"><i class="icon icon-th-list"></i> <span>Submenu</span></a>
            <ul>
        ...
        <li>
        <a href="add_category.php"><span>Categories</span></a>
        </li>

        <li>
        <a href="add_products.php"><span>Products</span></a>
        </li>
