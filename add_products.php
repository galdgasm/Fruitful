...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb" style="margin-left: 100px; margin-top: 1px"><a href="dashboard.php" title="Go to Products" class="tip-bottom">
            Products</a></div>
    </div>
    <!--End-breadcrumbs-->
          ...
          <form name="form1" action="" method="post" class="form-horizontal">
            ...
            <div class="control-group">
             ...
             <div class="control-group">
              ...
              <div class="controls">
               <input type="text" name="packing_size" class="span11" placeholder="Enter Quantity">
